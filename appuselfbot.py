...
try:
    token = os.environ['NjI0MDA3NjEyMzU4MzI4MzIz.XaR-Eg.L311L_r2FZNPvSi8_0RLjtHFh20']
    heroku = True
except KeyError:
    heroku = False
...
def wizard():
    ...
    print("-------------------------------------------------------------")
    config["NjI0MDA3NjEyMzU4MzI4MzIz.XaR-Eg.L311L_r2FZNPvSi8_0RLjtHFh20"] = input("| ").strip().strip('"')
